...
if __name__ == "__main__":
    ep_users = 'https://jsonplaceholder.typicode.com/users'
    ep_todos = 'https://jsonplaceholder.typicode.com/todos'
    list_users = requests.get(ep_users).json()
    list_tasks = requests.get(ep_todos).json()
